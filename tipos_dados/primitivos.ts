// Tipos primitivos em TypeScript: number, string, boolean e bigint.
...
// let nomeCompleto: string = `${nome} Hamon de Freitas Jardim`; // backticks
// console.log(nomeCompleto);

// console.log(`Meu nome completo é ${nomeCompleto}. Tenho ${idade} anos.`);
...
// Disponível a partir do target ES2020 no tsconfig.json.
